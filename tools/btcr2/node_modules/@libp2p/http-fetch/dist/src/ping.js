 ...
 */
export async function servePing(req) {
 ...
 */
export async function sendPing(node, peerIdOrMultiaddr) {
    const peerAddr = isPeerId(peerIdOrMultiaddr) ? multiaddr(`/p2p/${peerIdOrMultiaddr.toString()}`) : peerIdOrMultiaddr;
