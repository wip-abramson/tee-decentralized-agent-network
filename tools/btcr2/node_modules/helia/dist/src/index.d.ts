 ...
 */
export declare function createHelia<T extends Libp2p>(init: Partial<HeliaInit<T>>): Promise<Helia<T>>;
export declare function createHelia(init?: Partial<HeliaInit<Libp2p<DefaultLibp2pServices>>>): Promise<Helia<Libp2p<DefaultLibp2pServices>>>;
