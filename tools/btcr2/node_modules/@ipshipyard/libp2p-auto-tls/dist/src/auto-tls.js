...
export class AutoTLS {
    ...
    onSelfPeerUpdate;
    renewTimeout;
    accountPrivateKeyName;
    accountPrivateKeyBits;
    certificatePrivateKeyName;
    certificatePrivateKeyBits;
    certificateDatastoreKey;
    email;
    domain;
    domainMapper;
    autoConfirmAddress;
    ...
    [Symbol.toStringTag] = '@libp2p/auto-tls';
    [serviceCapabilities] = [
        '@libp2p/auto-tls'
    ];
    ...
    async fetchCertificate(multiaddrs, options) {
        ...
        let event = 'certificate:provision';
    ...
    async loadOrCreateCertificate(certificatePrivateKey, multiaddrs, options) {
    ...
    async loadCertificateIfExists(certificatePrivateKey) {
        ...
        try {
            ...
            try {
                ...
                if (!uint8ArrayEquals(new Uint8Array(certPublicKeyThumbprint, 0, certPublicKeyThumbprint.byteLength), new Uint8Array(keyPublicKeyThumbprint, 0, keyPublicKeyThumbprint.byteLength))) {
    ...
    async fetchAcmeCertificate(csr, multiaddrs, options) {
    ...
    async configureAcmeChallengeResponse(multiaddrs, keyAuthorization, options) {
...
//# sourceMappingURL=auto-tls.js.map