 ...
 */
export async function loadOrCreateKey(keychain, name, size) {
    let key;
    try {
...
export function formatAsPem(key) {
...
export function importFromPem(pem) {
    const obj = createPrivateKey({
        format: 'pem',
        key: pem
    });
...
export async function createCsr(domain, keyPem) {
