...
export declare namespace WantlistEntry {
    ...
    const decode: (buf: Uint8Array | Uint8ArrayList, opts?: DecodeOptions<WantlistEntry>) => WantlistEntry;
}
...
export declare namespace Wantlist {
    ...
    const decode: (buf: Uint8Array | Uint8ArrayList, opts?: DecodeOptions<Wantlist>) => Wantlist;
}
...
export declare namespace Block {
    ...
    const decode: (buf: Uint8Array | Uint8ArrayList, opts?: DecodeOptions<Block>) => Block;
}
...
export declare namespace BlockPresence {
    ...
    const decode: (buf: Uint8Array | Uint8ArrayList, opts?: DecodeOptions<BlockPresence>) => BlockPresence;
}
...
export declare namespace BitswapMessage {
    ...
    const decode: (buf: Uint8Array | Uint8ArrayList, opts?: DecodeOptions<BitswapMessage>) => BitswapMessage;
}
